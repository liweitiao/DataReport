...
url(r'^report20_add$', views.report20_add),
url(r'^baobiao20_add_queryStock$', views.baobiao20_add_queryStock),
url(r'^baobiao20_add_updateStock$', views.baobiao20_add_updateStock),
url(r'^baobiao20_add_addStock$', views.baobiao20_add_addStock),

url(r'^report20_add_dynamic$', views.report20_add_dynamic),
